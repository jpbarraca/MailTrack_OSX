...
class Updater:
    ...
    def __init__(self):
        ...
        try:
            ...
            NSLog("MailTrack: updater error - cannot initialize the updater for MailTrack. This usually happens because of compatibility issues between Mail plugins. Updates are disabled, but MailTrack should function normally.")
            self.enabled = False
            return
